...
namespace Microsoft.Samples.Debugging.CorDebug
{
 ...
 //Defined in metahost.h
                ...
                Guid IID_ICLRDebuggingLibraryProvider = new Guid(0xd28f3c5a, 0x9634, 0x4206, 0xa5, 0x9, 0x47, 0x75, 0x52, 0xee, 0xfb, 0x10);
                Object res;
 ...
 public static string[] GetDebuggerVersionFromPid4(int processId)
 {
       Guid CLSID_MetaHost = new Guid("9280188D-0E8E-4867-B30C-7FA83884E8DE");
        Guid IID_MetaHost = new Guid("D332DB9E-B9B3-4125-8207-A14884F53216");
        ICLRMetaHost metahost = (ICLRMetaHost)NativeMethods.ClrCreateInterface(CLSID_MetaHost, IID_MetaHost);
     ...
     //
        IEnumUnknown runtimes = metahost.EnumerateLoadedRuntimes(p.Handle);
        if (runtimes == null) throw new Exception("Cannot enumerate runtimes");
     object[] runtime=new object[]{new object()};
                ...
                do
                {
                    hr = runtimes.Next(1, runtime, out retrieved);
                    ICLRRuntimeInfo iRuntime = (ICLRRuntimeInfo)runtime[0];
                    if (iRuntime == null) break;
                    iRuntime.GetVersionString(version, ref bufsz);
